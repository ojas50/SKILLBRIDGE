  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        sun: "var(--sb-sun)",
        "sun-strong": "var(--sb-sun-strong)",
        neon: "var(--sb-neon)",
        platinum: "var(--sb-platinum)",
        crimson: "var(--sb-crimson)",
        "crimson-strong": "var(--sb-crimson-strong)",
        charcoal: "var(--sb-charcoal)",
        "cyan-accent": "var(--sb-cyan)",
        "cyan-strong": "var(--sb-cyan-strong)",
        brand: {
          50: "#eff6ff",
          100: "#dbeafe",
          200: "#bfdbfe",
